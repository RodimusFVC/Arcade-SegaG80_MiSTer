...
//
//  REVISION 2026-08-09 (this file): four invader voices reworked per
...
module astrob_audio (
    ...
    always @(posedge clk_sys or posedge reset) begin
        if (reset) begin
            ...
            inv2_g_cnt <= INV2_GATE_HALF; // resync gate phase on voice start
            inv2_hold  <= 1'b0;
    ...
    wire [21:0] inv4_span = (INV4_HALF_HI - INV4_HALF_LO) * inv4_code;
    wire [16:0] inv4_half = INV4_HALF_HI - inv4_span[20:4];   // /15 ~= >>4 - ok at this tolerance
